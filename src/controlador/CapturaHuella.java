...
//    private DPFPSample sample;
    ...
    public void ProcesarCaptura(DPFPSample sample) {
        ...
        featuresinscripcion = extraerCaracteristicas(sample, DPFPDataPurpose.DATA_PURPOSE_ENROLLMENT.DATA_PURPOSE_ENROLLMENT);
    ...
    public void identificarHuella() {
        ...
        if (featuresverificacion==null) {
            /*Dialogs.create()
                ...
                .showError();*/
            System.err.println("Ingresar huella");
        } else {
            ...
            for (int i=0; i < list.size(); i++) {
                ...
                if (templateBuffer != null) {
                    ...
                    if (result.isVerified()) {
                        ...
                        this.refController.setPaciente(obj);
                        this.refController.cargarPaciente();
                        bandera = true;
        ...
        if(!bandera)
            /*Dialogs.create()
                ...
                .showError();*/
            System.err.println("NO hay paciente con esta huella");
    }
