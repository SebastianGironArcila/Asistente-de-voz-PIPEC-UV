...
public class Zoom<X, Y> {
	 ...
	 */
	public Zoom(final Pane chartParent, final XYChart<X, Y> chart,
	 ...
	 *             if chart data is empty or {@code null}
	 */
	public Zoom(final Pane chartParent, final XYChart<X, Y> chart, final Series<X, Y>... series) {
