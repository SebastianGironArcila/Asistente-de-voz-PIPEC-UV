...
@NamedQueries({
    ...
    , @NamedQuery(name = "Medicion.findByTipoid", query = "SELECT m FROM Medicion m WHERE m.tipoid = :tipoid")
...
public class Medicion implements Serializable {
    ...
    public Medicion(Integer id, String tipoid, String ondaSPO2, String ondaECG1, String ondaECG2, String ondaRESP, String presionSistolica, String presionDiastolica, String pulso, String med, String ecg, String spo2, String hr, String resp) {
        this.id = id;
        this.tipoid = tipoid;
