...
import static controlador.CapturaHuella.toBufferedImage;
...
public class WebCam extends BorderPane {
    ...
    EstructuraBasicaController refController = null;
    
    public WebCam(Stage ventanaPrincipal, Stage primaryStage, EstructuraBasicaController refController) {
        // Using Sarxos API
...
//        this.primaryStage.show();
        ...
        primaryStage.setOnCloseRequest(new EventHandler<WindowEvent>(){
            @Override public void handle(WindowEvent event) {                
                ...
                refController.setOpenFoto(true);
                if(webCam!=null)
                {
    ...
    public void webcamImageObtained() {
        ...
        btnOk.setOnAction(new EventHandler<ActionEvent>() {   
            ...
            public void handle(ActionEvent event) {
                refController.actualizarFotoPacente(new ImageView(imagenTomada.getImage()));
