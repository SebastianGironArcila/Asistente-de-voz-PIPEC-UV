...
public class NuevoUsuarioController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // TODO 
        ObservableList<String> availableChoices = FXCollections.observableArrayList("Médico", "Administrador"); 
        ...
        try {
            ...
            if (val.equals("OK")) {
                ...
                if (resultado > 0){
                    ...
                    popup.setContentText("Error, usuario y/o contraseña del admin incorrecto(s)");
                    popup.showAndWait();
                }
    ...
    {        
        ...
        programaPrincipal.mensajePersonalizado("El usuario " + ajustesUsuario.getText()+ " ha sido creado con éxito", "Usuario creado con éxito");
        thisStage.close();
